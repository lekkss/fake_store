...
import { selectedProduct } from "../features/singleProductSlice";
      ...
      {loading ? (
        ...
        <div className="flex justify-center items-center h-screen">
          <div className="bg-white flex flex-row border-2 h-60 rounded-md m-5   border-gray-500 border-solid items-center center">
            ...
            <div className="flex flex-col p-4 border-l-2 border-gray-500 border-solid w-7/12 ">
              <div className=" md:text-3xl font-bold">{title}</div>
              <div className="text-sm text-orange-300 font-bold">${price}</div>
            </div>
          </div>
        </div>
      )}
